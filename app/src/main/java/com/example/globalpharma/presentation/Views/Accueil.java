...
import com.example.globalpharma.presentation.Controller.UserClient;
...
import static com.example.globalpharma.util.Constants.ERROR_DIALOG_REQUEST;
import static com.example.globalpharma.util.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.example.globalpharma.util.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
public class Accueil extends  AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private static GpsFragment instance;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationView navigation = findViewById(R.id.navigationMenuGlobalPharma);
